...
async function main() {
  ...
  //   limitOrderType,
  // } = await getLiquidityPosition(rt, accNo, 0, 0)
  ...
  // } = await getRealTokenBalances(rt, accNo, addrs.collateralToken.address, addrs2.settlementToken.address)
  ...
  // const z = await getNetTokenPosition(rt, accNo, AMM_CONFIG.POOL_ID)
