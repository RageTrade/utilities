...
export const NETWORK_INF0 = {
  ...
  GLP_BATCHING_MANAGER_WEBHOOK_URL:
    SECRET.GLP_BATCHING_MANAGER_WEBHOOK_URL as string,
  USDC_BATCHING_MANAGER_WEBHOOK_URL:
    SECRET.USDC_BATCHING_MANAGER_WEBHOOK_URL as string,
}
